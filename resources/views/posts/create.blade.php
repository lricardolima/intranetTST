                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('post.store') }}" method="post" class="mt-4" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Insira o título do artigo" name="title" value="{{ old('title') }}">
                            </div>
                            <div class="form-group">
                                <label for="content">Conteúdo</label>
                                <textarea class="form-control" id="content" rows="3" name="content" placeholder="Insira o conteúdo..."></textarea>
                            </div>
                            <div class="form-group">
